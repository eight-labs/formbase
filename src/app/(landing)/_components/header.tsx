          ...
          <div className="flex flex-wrap items-center justify-between py-2 sm:py-4">
            ...
            <div className="h-0 w-full flex-wrap items-center justify-end space-y-8 md:flex-nowrap lg:flex lg:h-fit lg:w-fit lg:space-y-0">
              ...
              {isLoggedIn ? (
                <Link
                  href="/dashboard"
                  className="flex w-full flex-col items-center gap-2 space-y-2 border-t border-[--ui-light-border-color] pb-4 pt-6 dark:border-[--ui-dark-border-color] lg:w-fit lg:flex-row lg:space-y-0 lg:border-l lg:border-t-0 lg:pb-0 lg:pl-2 lg:pt-0"
                >
